                        ...
                        <div class="login-form-item">
                            <div class="form-group">
                                ...
                                <div class="float-right">
                                    <a href="maine.jsp" class="text-small">
                                        游客登录
                                    </a>
                                    <%--//游客--%>
<%--    <a class="bbbug_login_form_title_guest el-link el-link--default is-underline"><!---->--%>
<%--        <span class="el-link--inner">游客</span><!----></a>--%>
                                </div>
...
<%--<script src="https://jike0.com/theme/malio/js/malio.js?5tgas4s"></script>--%>
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (data.ret == 1) {
                    ...
                    window.location.assign('maine.jsp');
...
<%--                <div class="text-center mt-4" id="telegram-login-box"><script src="https://telegram.org/js/telegram-widget.js?4" data-size="large" data-telegram-login="jike0_bot" data-auth-url="https://jike0.com/auth/telegram_oauth" data-request-access="write"></script></div>--%>
<%--                <div class="text-center mt-4 mb-3">--%>
<%--                    <div class="text-job text-muted">或者添加机器人账号 <a href="https://t.me/jike0_bot">@jike0_bot</a>，发送下面的数字给它</div>--%>
<%--                </div>--%>
<%--                <div class="text-center">--%>
<%--                    <h2><code id="code_number" style="color: #6777ef"></code></h2>--%>
<%--                </div>--%>
<%--            </div>--%>
<%--        </div>--%>
<%--    </div>--%>
...
<%--        el.setAttribute('data-telegram-login', 'jike0_bot')--%>
<%--        el.setAttribute('data-auth-url', 'https://jike0.com/auth/telegram_oauth')--%>
